...
public class Analysise {
	    ...
	    public static  int dataunittostandard(Protocol protocol){
			...
			try {
				...
				r=0;
				if (protocol.getSumCoolUnit().equals("W*h"))  {
					b = new BigDecimal(Double.valueOf(SumCool)/1000);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("10W*h"))  {
					b = new BigDecimal(Double.valueOf(SumCool)/100);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("100W*h"))  {
					b = new BigDecimal(Double.valueOf(SumCool)/10);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("kW*h"))  {
					b = new BigDecimal(Double.valueOf(SumCool));   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("MW*h"))  {
					b = new BigDecimal(Double.valueOf(SumCool)*1000);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
			    ...
			    if (protocol.getSumCoolUnit().equals("J"))  {
					b = new BigDecimal(Double.valueOf(SumCool)*0.0000002778);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("10J"))  {
					b = new BigDecimal(Double.valueOf(SumCool)*0.000002778);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("100J"))  {
					b = new BigDecimal(Double.valueOf(SumCool)*0.00002778);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("kJ"))  {
					b = new BigDecimal(Double.valueOf(SumCool)*0.0002778);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
			    if (protocol.getSumCoolUnit().equals("10kJ"))  {
					b = new BigDecimal(Double.valueOf(SumCool)*0.002778);   
					f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
					protocol.setSumCool(f1);
					r=1;
				}
			    else
				    if (protocol.getSumCoolUnit().equals("100kJ"))  {
						b = new BigDecimal(Double.valueOf(SumCool)*0.02778);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumCool(f1);
						r=1;
					}
				    else
				    if (protocol.getSumCoolUnit().equals("MJ"))  {
						b = new BigDecimal(Double.valueOf(SumCool)*0.2778);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumCool(f1);
						r=1;
					}
				    else
				    if (protocol.getSumCoolUnit().equals("10MJ"))  {
						b = new BigDecimal(Double.valueOf(SumCool)*2.778);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumCool(f1);
						r=1;
					}
				    else
				    if (protocol.getSumCoolUnit().equals("100MJ"))  {
						b = new BigDecimal(Double.valueOf(SumCool)*27.78);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumCool(f1);
						r=1;
					}
				    else
				    if (protocol.getSumCoolUnit().equals("GJ"))  {
						b = new BigDecimal(Double.valueOf(SumCool)*277.8);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumCool(f1);
						r=1;
					}
				    else
				    if (protocol.getSumCoolUnit().equals("10GJ"))  {
						b = new BigDecimal(Double.valueOf(SumCool)*2778);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumCool(f1);
						r=1;
					}
				    else
				    if (protocol.getSumCoolUnit().equals("100GJ"))  {
						b = new BigDecimal(Double.valueOf(SumCool)*27778);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumCool(f1);
						r=1;
					}
				    ...
				    if (protocol.getSumHeatUnit().equals("10W*h"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("100W*h"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("kW*h"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("MW*h"))  {
						b = new BigDecimal(Double.valueOf(SumHeat)*1000);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setSumHeat(f1);
						r=1;
				    ...
				    if (protocol.getSumHeatUnit().equals("J"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("10J"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("100J"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("kJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("10kJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("100kJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("MJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("10MJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("100MJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("GJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("10GJ"))  {
				    ...
				    if (protocol.getSumHeatUnit().equals("100GJ"))  {
				    ...
				    if (protocol.getTotalUnit().equals("10mL"))  {
				    ...
				    if (protocol.getTotalUnit().equals("100mL"))  {
				    ...
				    if (protocol.getTotalUnit().equals("L"))  {
				    ...
				    if (protocol.getTotalUnit().equals("10L"))  {
				    ...
				    if (protocol.getTotalUnit().equals("100L"))  {
				    ...
				    if (protocol.getTotalUnit().equals("m³"))  {
				    ...
				    if (protocol.getOppositeTotalUnit().equals("10mL"))  {
				    ...
				    if (protocol.getOppositeTotalUnit().equals("100mL"))  {
				    ...
				    if (protocol.getOppositeTotalUnit().equals("L"))  {
				    ...
				    if (protocol.getOppositeTotalUnit().equals("10L"))  {
				    ...
				    if (protocol.getOppositeTotalUnit().equals("100L"))  {
				    ...
				    if (protocol.getOppositeTotalUnit().equals("m³"))  {
				    ...
				    if (protocol.getPowerUnit().equals("10W"))  {
				    ...
				    if (protocol.getPowerUnit().equals("100W"))  {
				    ...
				    if (protocol.getPowerUnit().equals("kW"))  {
				    ...
				    if (protocol.getPowerUnit().equals("100kW"))  {
						b = new BigDecimal(Double.valueOf(Power)*100);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setPower(f1);
						r=1;
				    ...
				    if (protocol.getPowerUnit().equals("MW"))  {
						b = new BigDecimal(Double.valueOf(Power)*1000);   
						f1 = b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setPower(f1);
						r=1;
				    ...
				    if (protocol.getPowerUnit().equals("GJ/h"))  {
				    ...
				    if (protocol.getFlowRateUnit().equals("10mL/h"))  {
				    ...
				    if (protocol.getFlowRateUnit().equals("100mL/h"))  {
				    ...
				    if (protocol.getFlowRateUnit().equals("L/h"))  {
				    ...
				    if (protocol.getFlowRateUnit().equals("100L/h"))  {
				    ...
				    if (protocol.getFlowRateUnit().equals("m³/h"))  {
				    ...
				    if (protocol.getFlowRateUnit().equals("10m³/h"))  {
						b = new BigDecimal(Double.valueOf(FlowRate)*10);   
						f1 = b.setScale(3, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setFlowRate(f1);
						r=1;
				    ...
				    if (protocol.getFlowRateUnit().equals("100m³/h"))  {
						b = new BigDecimal(Double.valueOf(FlowRate)*100);   
						f1 = b.setScale(3, BigDecimal.ROUND_HALF_UP).doubleValue(); 
						protocol.setFlowRate(f1);
						r=1;
	  ...
	  //用于解析的方法
		...
		private static int MCAnalysisJSMTRxStr(String Data,Protocol protocol){
		      ...
		      try{
		        ...
		        char a[]=statusb.toCharArray(); 
		   	    ...
		   	    if (a[0]=='0'&a[1]=='0'&a[2]=='0'&a[3]=='0'&a[4]=='0'&a[5]=='0'&a[6]=='0'&a[7]=='0') status="正常";
		...
		private static int WCAnalysisJSMTRxStr1(String Data,Protocol protocol){
		       ...
		       else if (DataArea.substring(24,24+2).equals("28")) protocol.setOppositeTotalUnit("100mL");
		      ...
		      try{
		        ...
		        if (b[2]=='1') status=status+"低电";
		     	...
		     	if (b[5]=='1') status=status+"无水";
		   	    ...
		   	    if (b[0]=='0'&b[1]=='0'&b[2]=='0'&b[3]=='0'&b[4]=='0'&b[5]=='0'&b[6]=='0'&b[7]=='0') status="正常";
		   	    protocol.setStatus(status);
		 	   return r;
		    }
		...
		private static int MEAnalysisRxStr(String Data,Protocol protocol){
		      ...
		      if (Time1>=0) {
		        ...
		        switch (year.length()){
		        	case 0:year="0000";break;
		        	case 1:year="000"+year;break;
		        	case 2:year="00"+year;break;
		        	case 3:year="0"+year;break;
		        	case 4:break;
		        	default :break;
		        }
		        switch (month.length()){
		        	case 0:month="00";break;
		        ...
		        switch (hour.length()){
		        	...
		        	case 1:hour="0"+hour;break;
		        	case 2:break;
		        	default :break;
		        }
		        switch (min.length()){
		        	case 0:min="00";break;
		        	case 1:min="0"+min;break;
		        	case 2:break;
		        	default :break;
		        }
		        try{
