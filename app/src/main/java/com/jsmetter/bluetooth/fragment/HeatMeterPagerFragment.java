 ...
 * 综合Tab界面
 */
public class HeatMeterPagerFragment extends BaseViewPagerFragment implements
    ...
    protected void onSetupTabAdapter(ViewPageFragmentAdapter adapter) {
       ...
       //     @Override
        ...
        adapter.addTab(title[0], "heatwatermeterdata", MeterDataFragment.class,
                getBundle(0));
        adapter.addTab(title[1], "heatwatermeterlcd", MeterLcdFragment.class,
                getBundle(1));
        adapter.addTab(title[2], "heatwatermeterparam", HeatMeterParamFragment.class,
                getBundle(2));
        adapter.addTab(title[3], "heatwatermeteradjust", MeterAdjustFragment.class,
                getBundle(3));
